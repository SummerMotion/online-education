...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements EduCourseService {
    ...
    public String saveCourseInfo(CourseInfoVo courseInfoVo) {
        ...
        com.example.eduservice.entity.EduCourse eduCourse = new com.example.eduservice.entity.EduCourse();
        BeanUtils.copyProperties(courseInfoVo,eduCourse);
        int insert = baseMapper.insert(eduCourse);
        if(insert == 0) {
            //添加失败
            throw new ExampleException(20001,"添加课程信息失败");
        }
    ...
    public void updateCourseInfo(CourseInfoVo courseInfoVo) {
        ...
        if(update == 0) {
            throw new ExampleException(20001,"修改课程信息失败");
        }
    ...
    public void removeCourse(String courseId) {
        ...
        if(result == 0) { //失败返回
            throw new ExampleException(20001,"删除失败");
        }
    }
    //1 条件查询带分页查询课程
    @Override
